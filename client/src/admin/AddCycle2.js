    ...
    <>
      ...
      >
        <div className="container headertop">
          <div className="d-sm-flex align-items-center justify-content-between head">
            <div className="left">
                ...
                <div className="row">
                  <div className="col-md-12">
                    <h2 className="section-title mb-40">
                      <span className="text-marked">Add</span> <span style={{ color: 'black' }}>Products__</span>
                    </h2>
                  </div>
                </div>
              </div>
                  ...
                  <>
                    <form  >
                      ...
                      <div className="form-group row" style={{ color: 'black', marginTop: -10 }}>
                        <label style={{ textAlign: 'left' }} htmlFor="desc" className="col-sm-2 downn col-form-label">
                          Description:
                        </label>
                        <div className="col-sm-10">
                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                          <input type="file" name="photo" id="photo" style={{ paddingLeft: 8, paddingRight: 8 , paddingTop: 13}}
            ...
            <a href="https://svgshare.com/s/gH0" className="right" style={{ width: '50%' }}>
              <img class="img-fluid  d-none d-sm-block" src={url} title="" alt='' />
            </a>
          </div>
        </div>
      </section>
